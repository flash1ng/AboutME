...
Passionate about designing secure network infrastructures, performing penetration tests, and improving overall cybersecurity posture. Experienced with Cisco Packet Tracer, VLANs, firewalls, Ubuntu servers, OpenVAS, Nmap, Hydra, WordPress pentesting, and Maltego visualization.  

---

## 🛠 Skills & Tools

- **Networking & Infrastructure:** Cisco Packet Tracer, VLAN, inter-VLAN routing, firewall configuration, FTP servers, Ubuntu Server  
- **Offensive Security / Red Team:** Nmap, OpenVAS, Hydra, DVWA, WordPress pentesting, credential harvesting  
- **Security Visualization:** Maltego, network mapping, attack path analysis  
- **Other Tools:** VirtualBox, Linux, iptables, certificate authorities (OpenSSL)  
...
I enjoy combining network design and offensive security to better understand how attacks happen and how to prevent them.  
